...
<header id="top">
    ...
    <div class="row">
        ...
        <div class="header-content twelve columns">
            ...
            <h1 id="logo-text"><a href="index.html" title="">Ten trang web dat o day</a></h1>
            <p id="intro">Khau hieu...</p>
    ...
    <nav id="nav-wrap">
        ...
        <div class="row">
            ...
            <ul id="nav" class="nav">
                ...
                <li><a href="archives.jsp">Archives - Luu tru</a></li>
                <li class="has-children"><a href="javascript_page.jsp">Blog - Chu de</a>
                    <ul>
                        <li><a href="#">Chu de A</a></li>
                        <li><a href="#">Chu de B</a></li>
                    </ul>
                </li>
                <li><a href="login.jsp">Dang ky</a></li>
            </ul> <!-- end #nav -->
